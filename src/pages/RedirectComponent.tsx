//when a correct short link on bitwalee domain will be requested in browser, this page will be rendered and it will immediately redirect to the original url.
