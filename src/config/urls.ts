...
const PROD_API_URL = import.meta.env.VITE_PROD_API_URL || 'http://16.171.201.244:5000';
...
const PROD_REDIRECT_URL = import.meta.env.VITE_PROD_REDIRECTION_URL || 'http://16.171.201.244:8080'
